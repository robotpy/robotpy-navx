...
class NavXSimBase:
    ...
    def _read(self, data, count):
        ...
        if count == 18:
            ...
            AHRSProtocol.encodeBinaryUint16(
                self.cap_flags, data, IMURegisters.NAVX_REG_CAPABILITY_FLAGS_L
            )
        ...
        # data
            ...
            AHRSProtocol.encodeBinaryUint32(
                int(self.timer.getMsClock()),
                data,
                IMURegisters.NAVX_REG_TIMESTAMP_L_L - 4,
            )
            ...
            AHRSProtocol.encodeProtocolSignedHundredthsFloat(
                angle, data, IMURegisters.NAVX_REG_YAW_L - 4
            )
