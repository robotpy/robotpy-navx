...
StudicaLib 2026.0.2 adds USB support:
...
Desktop simulation can exercise the API, but does not validate physical USB
communication. Test the connection on your robot before relying on readings.
